...
library(ggplot2)
library(tidyr)
data = readxl::read_excel("Data/SeriesReport-20240118121709_2b83b7.xlsx", skip = 3)
inflation = read.csv("Data/CPIAUCSL (2).csv",
...
relative_to_white = data %>%
  ...
  summarize(Asian = MovAverage[Race == "Asian"]/MovAverage[Race == "White"],
            Black = MovAverage[Race == "Black"]/MovAverage[Race == "White"],
            All = MovAverage[Race == "All"]/MovAverage[Race == "White"],
            Hispanic = MovAverage[Race == "Hispanic"]/MovAverage[Race == "White"]) 

relative_to_date = data %>%
  filter(!is.na(MovAverage)) %>%
  group_by(Type, Sex, Race) %>%
  summarize(Index = MovAverage[Date == "2023-10-01"]/MovAverage[Date == "2019-10-01"]) 
...
growth = relative_to_date %>%
  ...
  ggtitle("Real Wages 2023 as a Percent of 2019 by Race and Sex")
...
growth_education = relative_to_date %>%
  ...
  ggtitle("Real Wages 2023 Percent of 2019 by Education and Sex")
...
growth_education_men = relative_to_date %>%
  ...
  ylab("Index of Usual Weekly Wages (2019 = 100%)") +
  scale_y_continuous(breaks = seq(0.92, 1.10, 0.02), labels = scales::label_percent()) + theme_bw() +
  ggtitle("Real Wages 2023 % of 2019 by Education for Men")
...
growth_education_women = relative_to_date %>%
  ...
  ylab("Index of Usual Weekly Wages (2019 = 100%)") +
  scale_y_continuous(breaks = seq(0.92, 1.10, 0.02), labels = scales::label_percent()) + theme_bw() +
  ggtitle("Real Wages 2023 % of 2019 by Education for Women")


relative_to_date2 = data %>%
  filter(!is.na(MovAverage)) %>%
  group_by(Type, Sex, Race) %>%
  summarize(Index = MovAverage[Date == "2023-10-01"]/MovAverage[Date == "2007-10-01"]) 
...
growth2 = relative_to_date2 %>%
  ...
  ggtitle("Real Wages 2023 as a Percent of 2007 by Race and Sex")

relative_to_date3 = data %>%
  filter(!is.na(MovAverage)) %>%
  group_by(Type, Sex, Race) %>%
  summarize(Index = MovAverage[Date == "2023-10-01"]/MovAverage[Date == "2016-10-01"]) 
...
growth3 = relative_to_date3 %>%
  ...
  ggtitle("Real Wages 2023 as a Percent of 2016 by Race and Sex")
...
growth_education3 = relative_to_date3 %>%
  ...
  ggtitle("Real Wages 2023 Percent of 2016 by Education and Sex")
...
growth_education3_men = relative_to_date3 %>%
  ...
  ylab("Index of Usual Weekly Wages (2019 = 100%)") +
  scale_y_continuous(breaks = seq(0.92, 1.20, 0.02), labels = scales::label_percent()) + theme_bw() +
  ggtitle("Real Wages 2023 % of 2016 by Education for Men")
...
growth_education3_women = relative_to_date3 %>%
  ...
  ylab("Index of Usual Weekly Wages (2019 = 100%)") +
  scale_y_continuous(breaks = seq(0.92, 1.20, 0.02), labels = scales::label_percent()) + theme_bw() +
  ggtitle("Real Wages 2023 % of 2016 by Education for Women")

relative_to_date4 = data %>%
  filter(!is.na(MovAverage)) %>%
  group_by(Type, Sex, Race) %>%
  summarize(Index = MovAverage[Date == "2023-10-01"]/MovAverage[Date == "2001-10-01"]) 
...
growth4 = relative_to_date4 %>%
  ...
  ggtitle("Real Wages 2023 as a Percent of 2001 by Race and Sex")

relative_to_date5 = data %>%
  filter(!is.na(MovAverage)) %>%
  group_by(Type, Sex, Race) %>%
  summarize(Index = MovAverage[Date == "2023-10-01"]/MovAverage[Date == "2022-04-01"]) 
...
growth5 = relative_to_date5 %>%
  ...
  scale_y_continuous(breaks = seq(0.96, 1.10, 0.02), labels = scales::label_percent()) + theme_bw() +
  ggtitle("Real Wages 2023 as a Percent of 2021 Q3-2022 Q2 \n by Race and Sex")
...
plot_this = function(type, race){
  ...
  xlab("Date") + ylab("Percent of White Wage") + scale_y_continuous(labels = scales::label_percent()) +
  ggtitle(title)
}
...
plot_percentile = function(type){
  ...
  data %>%
    ...
    ggplot(aes(x = Date, y = MovAverage, color = Race, linetype = Sex)) +
      geom_line(size = 1) + theme_bw() +   scale_x_date(date_breaks = "2 years", date_labels = "%Y") +
      ylab("Usual Weekly Wages (2023 Dollars)") + scale_y_continuous(labels = scales::label_comma()) +
      ggtitle(title)
}
...
plot_count = function(race){
  ...
  data %>%
    ...
    ggplot(aes(x = Date, y = MovAverage, color = Sex)) +
      geom_line(size = 1) + theme_bw() +  scale_x_date(date_breaks = "2 years", date_labels = "%Y") +
      ylab("Number of Full-Time Workers") + scale_y_continuous(labels = scales::label_comma()) +
      ggtitle(title)
}
